...
races_2018_2023_appended$Pos <- as.integer(as.numeric(races_2018_2023_appended$Pos))
nc_indices <- which(is.na(races_2018_2023_appended$Pos))


for (idx in nc_indices) {
  if (idx > 1) {
    races_2018_2023_appended$Pos[idx] <- races_2018_2023_appended$Pos[idx - 1] + 1
  }
}
races_2018_2023_appended$Pos <- ifelse(races_2018_2023_appended$Pos == 'NC', NA, races_2018_2023_appended$Pos)
races_2018_2023_appended$Pos <- zoo::na.locf(races_2018_2023_appended$Pos, fromLast = FALSE)
